...
-(NSInteger) runModalSheetForWindow:(NSWindow *)aWindow {
    bool exitHidden = [[aWindow standardWindowButton:NSWindowCloseButton] isHidden];
    bool miniHidden = [[aWindow standardWindowButton:NSWindowMiniaturizeButton] isHidden];
    bool zoomHidden = [[aWindow standardWindowButton:NSWindowZoomButton] isHidden];
    double wstyleMask = aWindow.styleMask;
    
    [[aWindow standardWindowButton:NSWindowCloseButton] setHidden:YES];
    ...
    aWindow.styleMask &= ~NSWindowStyleMaskResizable;
    ...
    [[aWindow standardWindowButton:NSWindowCloseButton] setHidden:exitHidden];
    [[aWindow standardWindowButton:NSWindowMiniaturizeButton] setHidden:miniHidden];
    [[aWindow standardWindowButton:NSWindowZoomButton] setHidden:zoomHidden];
    aWindow.styleMask = wstyleMask;
...
-(void) BE_beginSheetModalForWindow:(NSWindow *)aWindow {
    [self beginSheetModalForWindow:aWindow completionHandler:^(NSInteger modalCode){}];
}
